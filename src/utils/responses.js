...
const Responses = {
  ...
  _200(data = {}, origin = "http://localhost:8080") {
    return this._DefineResponse(200, data, origin);
  },
  _400(data = {}, origin = "http://localhost:8080") {
    return this._DefineResponse(400, data, origin);
  },
  _401(data = {}, origin = "http://localhost:8080") {
    return this._DefineResponse(401, data, origin);
  },
  _404(data = {}, origin = "http://localhost:8080") {
    return this._DefineResponse(404, data, origin);
  },
  _500(data = {}, origin = "http://localhost:8080") {
